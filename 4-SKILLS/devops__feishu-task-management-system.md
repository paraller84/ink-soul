...
version: "4.2.0"
description: "C012 飞书待办事项管理系统 — v4.2 待办回顾(07:30)+晚间复盘(18:30)合并入晨间简报09:00，形成「晨间全景」模板。命名格式：🔴/🟡 📝/📞/📅/⚡ 行动描述(≤10字)。2026-05-18 迁移22条任务，cron合并。2026-05-20 三次cron合并为一次推送。"
author: Hermes Agent
trigger: 用户说"记一个待办"、"创建任务"、"待办事项"、"会议待办"、"今日回顾"、"今天做什么"、"任务体系"、"系统架构"、"任务全景"、"task system"、或要求"创建飞书任务"、"放入飞书任务"、"在飞书任务中记录"等关键词
---

# C012 飞书待办事项管理系统

## ⚠️ 范围确认协议（2026-05-20 新增）
...
> **v4.0 变更**：日工作建议 cron 已于 2026-05-18 合并到晨间简报中。**v4.1 变更**：2026-05-18 作息调整，推送时间从 08:00 改为 **09:00**，加入交互式跟踪模板。**v4.2 变更**：2026-05-20 待办回顾（原07:30）+ 晚间复盘（原18:30）合并入晨间简报，形成「晨间全景」模板。三 cron 信息流呈衔接关系：昨日完成追踪→今日待办概览→全天节奏建议，合并为一次推送减少碎片。
