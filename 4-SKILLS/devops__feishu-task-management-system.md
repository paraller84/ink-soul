...
version: "3.0.0"
description: "C012 飞书待办事项管理系统 — v3.0 三层模型：🌲项目全景仪表盘+🌳C012动作清单+🌟日工作建议。v2.x（6分类+4层级+父子结构）向下兼容，v3.0为首选架构。"
author: Hermes Agent
...
| 模式 | 含义 | 处理方式 | 代表任务 |
|:----|:-----|:--------|:--------|
| 📝 **文书** | 写/改/审材料 | 需专注时段，至少30分钟 | `[EAST] 🔴 📝 写季度会汇报初稿` |
| 📞 **沟通** | 打电话/催进度/协调 | 集中处理，5-10分钟一条 | `[科创] 🟡 📞 催中银保信流程设计` |
| 📅 **会议** | 准备/参加/跟进 | 日历对齐 | `[EAST] 🔴 📅 5/28EAST季度会` |
| ⚡ **执行** | 系统操作/审批/碎片动作 | 碎片时间处理 | `[系统] 🟢 ⚡ 催中台权限` |
...
| 项目简称 | 对应专项 | 示例 |
|:--------|:--------|:-----|
| EAST | EAST数据治理/季度会/数据修正 | `[EAST] 📝 写季度会汇报初稿` |
| 科创 | 中银保信/科创对接 | `[科创] 📞 催中银保信流程设计` |
| 回复 | 一流阵地回复 | `[回复] 📝 终审定稿` |
| 团队 | 扩增/抽调/分工 | `[团队] 📞 确认泰科到位时间` |
| AI | 知识管理/聚类/垂类模型 | `[AI] ⚡ 跟庄老师聚类结果` |
| 系统 | DLP/安全/权限申请 | `[系统] 📞 催冯德明DLP方案` |
| 产险 | 产险数据修正/异常清理 | `[产险] ⚡ 异常单匹配映射` |
| 五报 | 五报四整改 | `[五报] 📝 写整改汇报` |
| 考核 | 考核修订 | `[考核] 📝 方案起草` |
| 项目 | 项目进度/苏总汇报 | `[项目] 📝 进度汇报苏总` |
